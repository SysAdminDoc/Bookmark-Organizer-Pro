...
| 🔄 R-41 | **tufup auto-update** — optional tufup 0.10.x extra, disabled-by-default update policy, HTTPS repository guard, trusted-root readiness, non-applying tufup checks, bootstrap docs, trusted target download staging, staged-update manifest readback, apply dry-run preflight, staged cleanup, and non-mutating apply planning shipped in v6.6.9-v6.6.11 and v6.6.23-v6.6.27. Applying downloaded updates remains gated. | In Progress | M | [S-28][S-88] |
