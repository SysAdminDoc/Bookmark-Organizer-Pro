...
- Refreshed README, working notes, and MCP tool metadata to match the live 56 CLI commands, 448 collected tests, 48 categories, 7,550 rules, keyring-first secret storage, and optional tray availability.
