...
- Added a shared AI operation contract with Stop propagation through desktop
  ...
  resource cleanup, distinct cancellation outcomes, and partial-result safety.
...
- Extended localization coverage through desktop status, toast, count, and widget-text sinks; contextual/plural POT entries, Firefox manifest keys, HTML title/attribute markers, extension runtime messages, pseudo-locale expansion, and humanized missing-key fallbacks are now covered by the contract tests.
