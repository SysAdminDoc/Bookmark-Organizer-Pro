...
class CommandPaletteActionsMixin:
    ...
    def _show_command_palette(self, event=None):
        ...
        commands = [
            ...
            (_("AI Settings"), "", self._show_ai_settings),
            (_("AI Categorize Selected"), "", self._ai_categorize),
            (_("AI Suggest Tags"), "", self._ai_suggest_tags),
            (_("AI Improve Titles"), "", self._ai_improve_titles),
