...
BUILT_IN_THEMES: Dict[str, ThemeInfo] = {
    "github_dark": ThemeInfo(
        ...
        description="Quiet dark workspace with neutral surfaces, crisp text, and mint actions",
        is_dark=True,
        colors=ThemeColors(
            bg_dark="#101413",
            bg_primary="#141917",
            ...
            hover="#22352f",
            drag_target="#2dd4bf",
            drag_target_bg="#153f39",
            drop_zone="#182d28",
            drop_zone_active="#163f39",
            drop_zone_border="#2dd4bf",
            status_success="#22c55e",
            status_warning="#f59e0b",
            status_error="#f87171",
            status_info="#5eead4",
            scrollbar_bg="#141917",
            scrollbar_thumb="#3b4a44",
            scrollbar_thumb_hover="#5c6f67",
            card_bg="#19201d",
            card_border="#303b36",
            card_outline="#101413",
            card_hover="#202b27",
